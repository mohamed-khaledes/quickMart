...
import "../../../Components/User/UserAllOrdersCard/UserAllOrdersCard.css";
import { Col, Row } from "react-bootstrap";
import { FaStar } from "react-icons/fa";
import baseUrl from '../../../Api/baseURL'
const AdminOrderItemCard = ({el}) => {
  return (
    <div className="user-all-order-card border-bottom my-2" id={el._id}>
      <Row className="user-order-card">
        <Col xs="12" sm="3" className="user-order-card-img">
